...
class SyntaxHighlighter:
    ...
    default_style = {
        "comment": u"\x1b[38;2;117;113;94m{}\x1b[0m",
        "keyword": u"\x1b[38;2;249;38;114m{}\x1b[0m",
        "builtin": u"\x1b[38;2;166;226;46m{}\x1b[0m",
        "string": u"\x1b[38;2;230;219;116m{}\x1b[0m",
        "number": u"\x1b[38;2;174;129;255m{}\x1b[0m",
        "operator": u"\x1b[38;2;249;38;114m{}\x1b[0m",
        "punctuation": u"\x1b[38;2;248;248;242m{}\x1b[0m",
        "constant": u"\x1b[38;2;102;217;239m{}\x1b[0m",
        "identifier": u"\x1b[38;2;248;248;242m{}\x1b[0m",
        "other": u"{}",
    }
...
class ExceptionFormatter:
    ...
    def __init__(self, colored=False, theme=None, style=None, max_length=128, encoding="ascii"):
    ...
    def _format_frames(self, frames):
        ...
        for frame in frames:
            ...
            if self._colored and is_mine:
                source = self._syntax_highlighter.highlight(source)

            frame_lines = [source] + self._format_relevant_values(relevant_values, self._colored)
            formatted_source = "\n    ".join(frame_lines)
    ...
    def _format_exception(self, value, tb, seen=None):
        ...
        if self._colored and len(exception_only) >= 3 and issubclass(exc_type, SyntaxError):
